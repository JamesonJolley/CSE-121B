...
if (dayOfWeek >=1 && dayOfWeek <= 5){
    message0 = 'Hang in there';
}
// Step 6: Using an else statement, set the message variable to 'Woohoo!  It is the weekend!'
else{
    message0 = 'Woohoo!  It is the weekend!'
}
...
switch (dayOfWeek) {
    ...
    case 6:
        ...
        break;
    default:
        message1 = 'error dayOfweek=' + dayOfWeek;
        break;
}
...
document.querySelector('#message1').textContent = message0;
...
fetch('https://byui-cse.github.io/cse121b-course/week05/temples.json').then(Response => Response.json())
.then(data => {
    temples = data
    output(temples)
})
